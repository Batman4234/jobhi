    ...
    <div className="fixed right-36 top-8 w-68">
      <Combobox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          <div
            className={`relative w-full cursor-default overflow-hidden rounded-[5px]  text-left shadow-md sm:text-sm bg-[#fcfdfc]`}
          >
            <Combobox.Input
          ...
          {query.trim().length > 0 && (
            ...
            >
              <Combobox.Options
                className={`absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-[#fcfdfc] py-1 text-base shadow-lg sm:text-sm`}
              >
